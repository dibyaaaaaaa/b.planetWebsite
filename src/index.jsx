    ...
    <div className="App">
      ...
      <header className="featured-section">
        ...
        <div className="product-grid">
          ...
          <div className="product-item"><img src={img4} alt="Tree2" className='plant-image2'/>Tree 2</div>
          <div className="product-item"><img src={img5} alt="Tree2" className='plant-image2'/>Tree 3</div>
          <div className="product-item"><img src={img6} alt="Tree2" className='plant-image2'/>Tree 4</div>
